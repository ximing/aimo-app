...
3. **搜索备忘录** - 在顶部搜索框输入关键词，快速查找
4. **管理分类** - 点击左上角菜单按钮，打开侧边栏进行分类管理
5. **编辑/删除** - 点击备忘录卡片进入详情，可以编辑或删除
...
- 提交 [Issue](https://github.com/yourusername/aimo-app/issues)
- 发送邮件至：morningxm@hotmail.com

---

**Made with ❤️ by Aimo Team**
